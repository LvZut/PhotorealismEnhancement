...
class evaluation_dataloader(Dataset):
    ...
    def __init__(self, dataset, gen, collate_fn_val, seed_worker):
        ...
        """
        self.gen = gen
        self.dataloader = torch.utils.data.DataLoader(self.dataset_fake_val, \
                            batch_size=1, shuffle=True, \
                            num_workers=0, pin_memory=True, drop_last=False, collate_fn=collate_fn_val, worker_init_fn=seed_worker)
